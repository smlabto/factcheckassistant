    ...
    if (user === 'user') {
        ...
        return (
            <div class="alert alert-light text-secondary small p-0 mb-3" role="alert" style={{ fontSize: "11px"}}>
                <p class="small mb-0">This app is a proof of concept and may occasionally produce misleading or incorrect information. It tends to perform better at processing English-based content. See <a href="#about" class="link-secondary">full disclosure</a> below.</p>
            </div>
        );
    }
}
