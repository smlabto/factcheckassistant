...
function Message({ user, message }) {
    ...
    if (user === 'user') {
        ...
        return (
            <div class="d-flex flex-row justify-content-end align-items-flex-end mb-4">             
                <div class="p-3 me-3 border" style={{ borderRadius: "15px", backgroundColor: "#fbfbfb" }}>
                    <p class="small mb-3">PS. Check if this or related claims have been independently verified through <a a target="_blank" href={"https://toolbox.google.com/factcheck/explorer/search/" + message} class="link-secondary">Google's Fact Check Tools</a>.</p>                   
                </div>
                <img src="../assets/img/avataaars.svg" width="32" height="32" alt=""/>            
            </div>
        );        
